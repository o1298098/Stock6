...
namespace Stock6.Droid.Renderer
{
    /// <summary>
    /// Entry cell renderer.
    /// </summary>
    [Android.Runtime.Preserve(AllMembers = true)]
    public class PasswordEntryCellRenderer : CellBaseRenderer<PasswordEntryCellView> { }
    [Android.Runtime.Preserve(AllMembers = true)]
    public class PasswordEntryCellView : CellBaseView, ITextWatcher,
        TextView.IOnFocusChangeListener, TextView.IOnEditorActionListener
    {
        PasswordEntryCell _EntryCell => Cell as PasswordEntryCell;
        ...
        public PasswordEntryCellView(Context context, Cell cell) : base(context, cell)
        {
    ...
    internal class AiEditText : EditText
    {
        ...
        {
            this.TransformationMethod = PasswordTransformationMethod.Instance;
        }
